            ...
            className={`h-[28px] px-3 rounded-btn text-[11px] font-semibold border transition-all duration-150 flex items-center justify-center gap-1.5 ${
              isDeleting
                ? intent === 'destructive'
                  ...
                  : 'bg-accent/50 text-white/50 border-accent/30 cursor-not-allowed'
                : intent === 'destructive'
                ? 'bg-red-bg text-red border border-red-border hover:bg-red/15 hover:border-red/80 cursor-pointer shadow-sm'
                : 'bg-accent text-white border border-accent hover:bg-accent-hover cursor-pointer shadow-sm'
            }`}
          >
            {isDeleting ? (
              <>
                <svg
                  className={`animate-spin h-3.5 w-3.5 mr-1 ${
                    intent === 'destructive' ? 'text-red/60' : 'text-white/60'
                  }`}
